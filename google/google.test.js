...
test('I can search Google', async () => {
    ...
    await searchBar.sendKeys('Apple Pie\n')
    ...
    await driver.findElement(By.name('q')).sendKeys('Pumpkin pie\n')
...
describe('A test I created to open the apple store website', () => {

    test('Open Apple Store Website', async () => {

    
    await driver.findElement(By.name('q')).clear() 

    await driver.findElement(By.name('q')).sendKeys('Apple Store\n')

    await driver.sleep(2000) 

    const appleStore = await driver.findElement(By.xpath('//a[@href= "https://www.apple.com/store"]')).click()
